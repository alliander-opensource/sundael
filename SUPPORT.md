...
There are a few ways to connect with the `sundael` project:

* Submit an issue.
* Send an email to the Technical Steering Committee: InzichtinBasislast@alliander.com.

## How to ask for help, suggest a feature, or give recommendations.

If you have trouble installing, building, or using the sundael, 
...
email InzichtinBasislast@alliander.com to responsibly disclose it.
